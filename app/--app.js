...
export default function App() {
  ...
  const analyzeImage = async () => {
    ...
    try {
      ...
      console.log('Preparando imagem para envio:', {
        uri: localUri,
        filename,
        type
      });
      ...
      if (Platform.OS === 'web') {
        ...
        // Garantir que a URI está no formato correto
        const imageUri = localUri?.startsWith("file://") ? localUri : `file://${localUri}`;
        
        // Ajustar o tipo da imagem
        const imageType = type === "image/jpg" ? "image/jpeg" : type || "image/jpeg";
      ...
      console.log('Enviando requisição para:', BACKEND_URL);
